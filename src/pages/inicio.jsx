        ...
        <section id="inicio" className="w-full h-screen flex items-center justify-center pt-20 bg-[#F7F1E1] md:bg-transparent">
            ...
            <div className="flex gap-4 px-5 z-10 font-['Inter']">
                <div className=" flex flex-col gap-10 md:gap-6 justify-center">
                    <h1 className="text-4xl font-bold text-gray-900 md:text-orange-800 md:text-6xl">O cuidado que seu pet merece, pertinho de você!</h1>
                    <p className="text-gray-700 text-xl font-normal text-capitalize md:text-2xl md:text-stone-700">Na Pet Center, unimos amor, tecnologia e profissionais especializados para garantir a saúde e a alegria do seu melhor amigo de asas ou quatro patas.</p>
                    ...
                    <a href="#servicos" className="text-white text-2xl font-normal text-capitalize cursor-pointer bg-orange-500 p-4 rounded-md w-max hover:bg-orange-400 md:bg-orange-600 md:hover:bg-orange-500 md:hover:text-gray-200 transition-all duration-300 shadow-lg hover:shadow-xl">Serviços</a>
                </div>
